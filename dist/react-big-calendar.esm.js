...
function Agenda(_ref) {
  ...
  var renderDay = function renderDay(day, events, dayKey) {
    ...
    return events.map(function (event, idx) {
      ...
      return /*#__PURE__*/ React.createElement(
        ...
        {
          key: dayKey + '_' + idx,
          className: 'agenda-grid-top-header '.concat(
            first && 'agenda-topLine'
          ),
        ...
        /*#__PURE__*/ React.createElement(
          ...
          {
            className: ''.concat(
              event !== null && event !== void 0 && event.actual
                ? 'agenda-actual'
                : 'actual-empty'
            ),
          },
          event !== null && event !== void 0 && event.actual
            ? event === null || event === void 0
              ? void 0
              : (_event$actual = event.actual) === null ||
                _event$actual === void 0
              ? void 0
              : _event$actual.toFixed(2)
            : '-'
        ),
        /*#__PURE__*/ React.createElement(
          'div',
          {
            className: ''.concat(
              event !== null && event !== void 0 && event.estimate
                ? 'agenda-estimate'
                : 'estimate-empty'
            ),
          },
          event !== null && event !== void 0 && event.estimate
            ? event === null || event === void 0
              ? void 0
              : (_event$estimate = event.estimate) === null ||
                _event$estimate === void 0
              ? void 0
              : _event$estimate.toFixed(2)
            : '-'
        ),
        /*#__PURE__*/ React.createElement(
          'div',
          {
            className: ''.concat(
              event !== null && event !== void 0 && event.change
                ? 'agenda-change'
                : 'change-empty'
            ),
          },
          event !== null && event !== void 0 && event.change
            ? event === null || event === void 0
              ? void 0
              : (_event$change = event.change) === null ||
                _event$change === void 0
              ? void 0
              : _event$change.toFixed(2)
            : '-'
        ),
        /*#__PURE__*/ React.createElement(
          'div',
          ...
          event !== null && event !== void 0 && event.previous
            ? event === null || event === void 0
              ? void 0
              : (_event$previous = event.previous) === null ||
                _event$previous === void 0
              ? void 0
              : _event$previous.toFixed(2)
            : '-'
        )
      )
    }, [])
  ...
  var _adjustHeader = function _adjustHeader() {
    ...
    var _widths = []
    console.log(
      firstRow === null || firstRow === void 0 ? void 0 : firstRow.children
    )
    var _iterator = _createForOfIteratorHelper(firstRow.children),
      _step
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        var elem = _step.value
        console.log(elem)
        _widths.push(getWidth(elem))
      }
    } catch (err) {
      _iterator.e(err)
    } finally {
